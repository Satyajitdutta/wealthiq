...
**Data & Privacy:**
We collect only what's needed: your email (for login) and the financial data you choose to share. Payments are handled securely by Razorpay. We never sell your data.

For support: info@pithonix.ai
...
- In-app subscriptions via Razorpay
- Available in: India (initial launch)
- Contains ads: No
- Contains in-app purchases: Yes (subscription plans)
